...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (path === '' || path.endsWith('index.html') || path.includes('/maldita-dulzura')) {
    ...
    await Promise.all([
      ...
      loadComponent('filosofia',     'filosofia.html'),
    ...
    console.log("Cargando página contacto");
    await loadComponent('nuestrosproductos', 'nuestrosproductos.html');
  }
    ...
    console.warn("Ruta no reconocida, cargando contenido por defecto");
    // Aquí podríamos cargar un componente genérico o mostrar un mensaje
  }
